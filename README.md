...
if ((Get-FileHash .\JZLite.tgz -Algorithm SHA256).Hash.ToLowerInvariant() -ne "e3154c95d2b0010898c7df0dfec2754995280928975e3625cd6d80adf428d072") { throw "Checksum mismatch. Do not run this download." }
