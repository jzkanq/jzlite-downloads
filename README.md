...
if ((Get-FileHash .\JZLite.tgz -Algorithm SHA256).Hash.ToLowerInvariant() -ne "1659496be82fdd323463f05d1b7a2543f1d30fffdc3fc507a236e5cace9253aa") { throw "Checksum mismatch. Do not run this download." }
